...
import { registerTeacher, loginTeacher, getAllTeachers, logoutTeacher, getStudentsByLecture, getLectures, isTeacherAuthenticated } from '../controllers/teacher_controller.js';
...
teacherRouter.get('/is-teacher-auth', teacherAuth, isTeacherAuthenticated);
