// ─────────────────────────────────────────────────────────────
//  k6 Load Test — MERN Backend (ClassMonitor) - WITHOUT CACHE
//  Usage:
//    k6 run load-test-wo-cache.js                         (console output)
//    k6 run --out json=results.json load-test-wo-cache.js  (save raw data)
//    k6 run --out csv=results.csv  load-test-wo-cache.js   (save CSV)
//
...
// docker command = docker run -i -v %cd%:/scripts grafana/k6 run /scripts/load-test-wo-cache.js
