...
const Home = () => {
  ...
  // Tab navigation state for student dashboard
  ...
  // Show student dashboard if logged in, otherwise show landing page
  if (isLoggedin && userData) {
    return (
      <div className="teacher-front-page"> {/* Using the same minimal aesthetic class */}
          ...
          <div className="content-area">
            <div className="content-wrapper">
              <div className="tab-content-wrapper">
                ...
                {activeTab === 'timetable' && <TimetableViewer isEmbedded={true} />}
                {activeTab === 'attendance' && <AttendanceDashboard isEmbedded={true} />}
              </div>
            </div>
          </div>
        </div>
