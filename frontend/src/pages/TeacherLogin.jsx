...
const TeacherLogin = () => {
  ...
  const { backendUrl, setIsLoggedin, getTeacherData } = useContext(AppContext)
  ...
  const onSubmitHandler = async (e) => {
    try {
      ...
      if (state === 'Sign Up') {
        const { data } = await axios.post(backendUrl + '/teachers/register', { name, email, password })
        ...
        const { data } = await axios.post(backendUrl + '/teachers/login', { email, password })
      ...
      <div className='login-container'>
        ...
        {state === 'Sign Up' ? (
          ...
          <p className='switch-auth'>
            ...
            <span onClick={() => setState('Sign Up')} className='switch-link'>
              Sign-up Here
            </span>
          </p>
        )}
